...
class Event(object):
    """Event """
    def __init__(self, event_id, event_type, data, transaction=None, user=None, source_addr=None, dest_addr=None):
        """ """
...
class AuditEvent(Event):
    """Job """    
    def __init__(self, event_id, data, transaction=None, user=None, source_addr=None, dest_addr=None):
